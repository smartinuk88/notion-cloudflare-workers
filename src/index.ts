...
app.post('/chatToDocument', async (c) => {
	try {
		...
		console.error('Error during chatToDocument execution:', error);

		// Return a user-friendly error message
		return c.json({ error: 'An error occurred while processing your request. Please try again later.' }, { status: 500 });
	}
});
